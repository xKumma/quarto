...
public class RuleBlockEndMovePlayer extends Rule{
    ...
    public boolean conditionRule(FactsHandler facts) {
        System.out.println("Condition RuleBlockEndMovePlayer executed"); // Test code - to be removed!
    ...
    public boolean actionRule(FactsHandler facts, Board board, Move move) {
        ...
        System.out.println("Action RuleBlockEndMovePlayer executed"); // Test code - to be removed!

        // Code to be added is this rule could initiate a new fact

        board.determineBlockEndMove(move);
